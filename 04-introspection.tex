...
\input "|./highlight.py samples/04lambda.txt fontsize=!small,firstline=12 no"
\end{frame}
...
\input "|./highlight.py samples/04wrapup.txt fontsize=!small,lastline=8 no"
\end{frame}
...
\bigskip
\input "|./highlight.py samples/04wrapup.txt fontsize=!scriptsize,firstline=10,lastline=19 no"
\end{frame}
...
\bigskip
\input "|./highlight.py samples/04wrapup.txt fontsize=!scriptsize,firstline=21 no"
\end{frame}
